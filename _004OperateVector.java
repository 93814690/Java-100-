...
public class _004OperateVector {
/*
 ...
 */
	...
	public static void main(String[] args) {
		_004OperateVector ov = new _004OperateVector();
		Vector vTemp = ov.buildVector();
		ov.print("vTemp",vTemp);
		Vector vResult = ov.insert(vTemp,2,"tianjiadeshuju");
		ov.print("vResult",vResult);
		Vector vResultup = ov.updata(vResult,2,"xiugaide");
